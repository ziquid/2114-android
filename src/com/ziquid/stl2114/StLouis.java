...
public class StLouis extends Activity {
    ...
    private static final int MENU_QUESTS = Menu.FIRST + 1;
    ...
    public static String TAG = "stlouis";
...
*/
        ...
        String data = "<html>" +
        	...
        	"src=\"file:///android_asset/stlouis_splash.jpg\"></span></body>" +
            "</html>";
...
//        engine.loadUrl(getString(R.string.url_home) + androidID);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	menu.add(0, MENU_HOME, 0,
        	R.string.menu_home)
        	.setIcon(R.drawable.stlouis_home);
       	
    	menu.add(0, MENU_QUESTS, 1,
        	R.string.menu_quests)
        	.setIcon(R.drawable.stlouis_quests);

    	menu.add(0, MENU_ELECTIONS, 2,
            	R.string.menu_elections)
            	.setIcon(R.drawable.stlouis_debates);

    	menu.add(0, MENU_AIDES, 3,
        	R.string.menu_aides)
        	.setIcon(R.drawable.stlouis_aides);
...
//    		engine.clearCache(true); // clear the cache whenever we go home
    	...
    	case MENU_QUESTS:
    		engine.loadUrl(getString(R.string.url_quests) + androidID);
            return true;

    	case MENU_ELECTIONS:
    		engine.loadUrl(getString(R.string.url_elections) + androidID);
            return true;
